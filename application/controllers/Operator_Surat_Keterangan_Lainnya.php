...
class Operator_Surat_Keterangan_Lainnya extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('operator/surat_keterangan_lainnya', $data);
    ...
    public function tambah_surat()
    {
        ...
        if (($this->form_validation->run() == TRUE) && (!empty($_FILES['file']['name']))) {
            ...
            if ($this->upload->do_upload('file')) {
                ...
                redirect('Operator_Surat_Keterangan_Lainnya');
            } else {
