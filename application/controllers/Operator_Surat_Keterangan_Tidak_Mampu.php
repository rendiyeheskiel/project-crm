...
class Operator_Surat_Keterangan_Tidak_Mampu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('operator/surat_keterangan_tidak_mampu', $data);
    ...
    public function tambah_surat()
    {
        ...
        if (($this->form_validation->run() == TRUE) && (!empty($_FILES['file']['name']))) {
            ...
            if ($this->upload->do_upload('file')) {
                ...
                redirect('Operator_Surat_Keterangan_Tidak_Mampu');
            } else {
